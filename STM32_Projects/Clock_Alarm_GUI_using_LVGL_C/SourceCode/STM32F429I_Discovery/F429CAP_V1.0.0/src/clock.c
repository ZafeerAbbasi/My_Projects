...
# HISTORY:                                                                     #
*//**/
/*This file is about manipulating data regarding the clockData_t element of the Main Clock object*/
 ...
 */
bool isAlarm( clockData_t *const clkData )
{
 ...
 * @param clkData 
 */
void dataBaseUpdateCurrentTime( clockData_t *const clkData )
{
    /*Increment Time*/
    clkData->timeNow += 1;
 ...
 */
void setAlarmTime( clockData_t *const clkData, uint32_t newTime )
{
 ...
 */
void setClockTime( clockData_t *const clkData, uint32_t newTime )
{
 ...
 */
void setClockDate( clockData_t *const clkData, date_t *const newDate )
{
    /*Set ClkData = NewDate*/
 ...
 */
uint32_t clockGetCurrentTime( clockData_t *const clkData )
{
 ...
 */
uint8_t clockGetTime12H24H( clockData_t *const clkData )
{
 ...
 */
void clockGetDate(clockData_t *const clk_inst, date_t *const date)
{
...
/**
 * @brief Take in a clock instance of type clockData_t and set initial date/time
 * 
 * @param clock_element clockData_t member of the main ClockAlarmUI_t object, i.e. clock_inst 
 */
void createClock(clockData_t *const clock_element)
{
